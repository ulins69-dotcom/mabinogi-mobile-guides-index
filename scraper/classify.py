...
CATEGORY_RULES = [
    ...
    ("職業解析", [
        ...
        "음유시인", "댄서", "악사",
        "도적", "격투가", "듀얼 블레이드",
        "전격술사",  # 電擊術士（2026-09-09 台版上線，見下方 CLASS_ALIASES 更新說明）
    ]),
    ("活動情報", [
...
CLASS_ALIASES = {
    ...
    # 電擊術士：2026-09-09台版「曠野的閃光」大改版正式上線（官網 tw.nexon.com
    # 職業介紹頁已確認，魔法師系列第4個轉職），2026-09-16 從下方 UPCOMING_CLASSES
    # 轉正過來，不再標「尚未開放」。「電擊魔法師」是社群曾用的舊稱一併保留比對。
    "電擊術士": "魔法師", "電擊魔法師": "魔法師", "전격술사": "魔法師",
}

# 韓服已上線、但台版官網（tw.nexon.com「公告」「更新」頁）尚未公布任何時間的轉職。
# 來源：namu.wiki「마비노기 모바일/클래스」（韓文攻略 wiki，2026-08-19 版本）：
#   戰士系列＋騎士（기사，韓服 2026-04-23 上線）
#   治癒師系列＋暗黑術士（암흑술사，韓服 2025-10-16 上線）
# 電擊術士已於 2026-09-09 台版上線，已移至上方 CLASS_ALIASES（2026-09-16）。
